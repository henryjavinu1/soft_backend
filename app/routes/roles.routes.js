...
module.exports = function(app) {
  ...
  app.post("/api/roles/buscarol",[authJwt.verifyToken,], controller.buscarol);//trae todos los roles 
  app.post("/api/roles/buscarolname",[authJwt.verifyToken,], controller.buscarolname);//trae todos los roles 
};